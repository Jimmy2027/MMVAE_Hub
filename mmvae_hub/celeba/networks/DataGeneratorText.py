...
from mmvae_hub.celeba.networks.ResidualBlocks import ResidualBlock1dTransposeConv
...
class DataGeneratorText(nn.Module):
    def __init__(self, args,num_features, a, b):
        ...
        self.resblock_6 = res_block_decoder(2*args.DIM_text, args.DIM_text,
                                                 kernelsize=4, stride=2, padding=1, dilation=1, o_padding=0);
        self.conv2 = nn.ConvTranspose1d(self.args.DIM_text, num_features,
                                        kernel_size=4,
                                        stride=2,
                                        padding=1,
                                        dilation=1,
