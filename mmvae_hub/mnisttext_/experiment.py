...
from mmvae_hub.mnisttext_.MNISTmod import MNIST
from mmvae_hub.mnisttext_.SVHNMNISTDataset import SVHNMNIST
from mmvae_hub.mnistsvhntext.SVHNmod import SVHN
# from utils.BaseExperiment import BaseExperiment
from mmvae_hub.mnisttext_.metrics import mnistsvhntextMetrics
...
class MNISTSVHNText(BaseExperiment):
    ...
    def set_modalities(self):
        ...
        mod3 = CelebaText(self.flags, len_sequence=256, alphabet=self.alphabet)
